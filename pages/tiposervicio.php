    ...
    <body>
        ...
        <article id="content">
            <div class="container-fluid">
                        ...
                        <div class="panel panel-default panel-table panel-info">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../img/menu/tipo de servicio.png" height="65">
                                    </div>
                                    <div class="col col-xs-3">
                                        <h3>Listado De Tipo De Bienes</h3>
                                    </div>                                    
                                </div>
                                <br>
                                <div class="row">
                            ...
                            <div class="panel-body">
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php
                                        $tipos = ctrTipoServicio::getTiposServicios();
                                        foreach ($tipos as $tipo) {
                                            if ($tipo->getEstado() == true ) {
                                                $id = $tipo->getIdTservicio();
                                                ?>
                                                <tr>                                           
                                                    <td align="center"><?= $tipo->getIdTservicio() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Tipo Servicio" >
                        <form class="form-horizontal " role="form" id="frmTipoServicio">
                            <input type="hidden" name="idTipoServicio" id="_idTipoServicio" value="0"/>
        ...
        <script>
            ...
            $(function () {
                $('#frmTipoServicio').on({
                    submit: function () {
                        var form = $('#frmTipoServicio');
                        var disabled = form.find(':input:disabled').removeAttr('disabled');
                        var serialized = form.serialize();
                        disabled.attr('disabled', 'disabled');
                        $.ajax({
                            url: "tiposervicioopc.php",
                            data: serialized,
                            type: 'POST',
                            dataType: 'json',
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idTipoServicio').val(json.idTipoServicio);
