        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../img/menu/marcas.png" height="65">
                                    </div>
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($marcas as $marca) {
                                            if ($marca->getEstado() == true) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td align="center"><?= $marca->getIdMarca() ?></td> 
                                                    <td align="center"><?= $marca->getDescripcion() ?></td>
                                                    <?php if ($marca->getEstado() != true) { ?>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Marcas" >
                        <form class="form-horizontal " role="form" id="frmMarca">
                            <input type="hidden" name="idMarca" id="_idMarca" value="0"/>
