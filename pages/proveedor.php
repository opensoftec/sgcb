        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../img/menu/proveedor.png" height="65">
                                    </div>
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($proveedores as $proveedor) {
                                            if ($proveedor->getEstado() == true) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td align="center"><?= $proveedor->getIdProveedor() ?></td>
                                                    <td align="center"><?= $proveedor->getNombre() ?></td>
                                                    <td align="center"><?= $proveedor->getSucursal() ?></td>
                                                    <td align="center"><?= $proveedor->getDireccion() ?></td>
                                                    <td align="center"><?= $proveedor->getTelefono() ?></td>
                                                    <td align="center"><?= $proveedor->getResponsable() ?></td>
                                                    <?php if ($proveedor->getEstado() != true) { ?>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Ingreso de Proveedores" >
                        <form class="form-horizontal " role="form" id="frmProveedor">
                            <input type="hidden" name="idProveedor" id="_idProveedor" value="0"/>
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_nombre" name="nombre" placeholder="" maxlength="" required="true" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}">
                                        </div>
                                        <label class="control-label col-xs-2">Sucursal:</label>
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_sucursal" name="sucursal" placeholder="" maxlength="" required="true" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_direccion" name="direccion" placeholder="" maxlength="" required="true">
                                        </div>
                                        <label class="control-label col-xs-2">Telefono:</label>
                                        <div class="col-xs-4">
                                            <input type="tel" class="form-control" id="_telefono" name="telefono"  required="true" pattern="[0-9]{10}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_responsable" name="responsable" placeholder="" maxlength="" required="true" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}">
                                        </div>
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idProveedor').val(json.idProveedor);
                            $('#_nombre').val(json.nombre);
                            $('#_sucursal').val(json.sucursal);
