        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../img/menu/caja.png" height="65">
                                    </div>
                                    <div class="col col-xs-3">
                                        <h3>Cobro Ordenes de Servicio</h3>
                                    </div>                                    
                                </div>
                                <br>
                                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if ($ordenIngreso->getEstado() == 2 || $ordenIngreso->getEstado() == 3 || $ordenIngreso->getEstado() == 4 || $ordenIngreso->getEstado() == 6) { ?>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="#" rel="edit" data-id="action=edit&id=<?= $id ?>">
                                                                    <i class="glyphicon glyphicon-edit"></i> Cobrar
                                                                </a>
                                                                <li>
                                                                    <a href="reportes/report_1.php?num=<?= $id ?>" target="_block">
                ...
                <div class="container modal" id="mymodal">
                    <div  id="dialog"  title="Ingreso de Pago" >
                            ...
                            <div id="tabs">
                                <div id="tabs-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <textarea id="_cumplimiento" name="cumplimiento" rows="5" cols="74" disabled="false"></textarea>
                                        </div>
                                       
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-xs-2">Det x Cob:</label>
                                        <div class="col-xs-4">
                                            <textarea id="_detalle" name="detalle" rows="3" cols="74" disabled="false"></textarea>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function (json, textStatus, jqXHR) {
                        ...
                        $('#_cumplimiento').val(json.cumplimiento);
                         $('#_detalle').val(json.observacionTecnico);
